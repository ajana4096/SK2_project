...
int move_king(int board[8][8], int x1, int y1, int x2, int y2, int side)
{
}
int move(int board[8][8], int player1[12], int player2[12], int x1, int y1, int x2, int y2, int side)
{
    ...
    if (side == 1)
    {
        ...
        {
            return move_king(board, x1, y1, x2, y2, side);
        }
    }
    else
    {
...
int jump_king(int board[8][8], int x1, int y1, int x2, int y2, int side)
{
...
int jump(int board[8][8], int player1[12], int player2[12], int x1, int y1, int x2, int y2, int side)
{
    ...
    if (side == 1)
    {
        ...
        {
            return jump_king(board, x1, y1, x2, y2, side);
        }
    }
    else
    {
